...
class GenericonsHELF {
    ...
    static $gen_ver = '3.1.0.0'; // Plugin version so I can be lazy
    ...
    // Content of the settings page
 	function settings_page() {
		...
		<div class="wrap">
	        ...
	        <p>Need more examples? Check out <a href="<?php echo plugins_url( 'genericons/font/example.html', __FILE__); ?>">the official Genericons Examples</a> or <a href="http://wordpress.org/plugins/genericond/faq/">the Genericon'd FAQ</a>. Please don't ask me to add more Genericons, though, this is an Automattic creation, I just stuck it in a plugin.</p>		
			</div>
